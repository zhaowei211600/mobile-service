...
@Component
public class OperationUserHelper {
    ...
    private Claims getClaimsFromToken(String token) {
        ...
        try {
            claims = Jwts.parser()
                    .setSigningKey(operationToken.getBase64Secret())
    ...
    private Date generateExpirationDate() {
        return new Date(System.currentTimeMillis() + operationToken.getExpiresSecond());
    }
    ...
    String generateNewToken(Map<String, Object> claims) {
        return Jwts.builder()
                ...
                .signWith(SignatureAlgorithm.HS512, operationToken.getBase64Secret())
                .compact();
    }
