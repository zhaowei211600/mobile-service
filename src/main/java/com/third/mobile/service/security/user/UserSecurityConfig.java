...
import com.third.mobile.exception.CustomizationAccessDeniedHandler;
import com.third.mobile.exception.EntryPointUnauthorizedHandler;
...
public class UserSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
                ...
                .antMatchers("/user/file/stream").permitAll()
                .antMatchers("/require/commit").permitAll()
